...
export const CrewTopPage = (props: {
    ...
    const displayModes = ['Base', 'Gauntlet', 'Gauntlet Rank'];//, 'Shuttle Pair'];
    ...
    function getColumns(rowData: CrewData[][]) {
        ...
        props.meta.forEach((rm,i) => {
            ...
            _columns.push({
                ...
                show: !allZero,
                resizable: false,
                Cell: (cell) => <Image src={cell.original[i].iconUrl} width={22} height={22} imageFit={ImageFit.contain} shouldStartVisible={true} />
            });
